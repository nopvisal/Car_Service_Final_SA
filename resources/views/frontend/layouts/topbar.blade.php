...
<div class="container-fluid  p-0">
    <div class="row gx-0 d-lg-flex nav-top">
        <div class="col-lg-5 col-9 nav-p text-start">
            <a href="#" class="navbar-brand d-flex align-items-center ">
                <h2 class="m-0 text-warning"><i class="fa fa-car me-3"></i>VI-FIX</h2>
            </a>

        </div>
        <div class="col-lg-3 col-1  text-end dis">
             @auth('customer')
             <h4 style="width:150px;position:absolute;top:10px;right:0px;color:white;">Welcome, {{ Auth::guard('customer')->user()->name }}</h4>
             @endauth
        </div>
        <div class="col-lg-3 col-1  text-end dis">
